...
for(l=0;l<3;l++){
		for (c=0;c<4;c++){
		cin >> matriz [l] [c];   //matriz [l] [c] =0; posso colocar um valor fixo
...
int main (int argc, char *argv[]){ // int argc armazena a quantidade de argumentos, e o argv armazena os argumentos

	cout << argv [0] << "\n\n";  //por padrão o primerio parametro é o nome do programa
...
//FUNÇÕES
//tipo de retorno de uma função, nome, argumentos
...
void texto();//No C++ precisa prototipar apresentando a função  para que o C conheça a função Texto
...
int main () {
	...
	//passando valores para utilizar a funcao soma2 e armazenando o resultado em res
	res=soma2(175,25);
...
//somando e retornando um valor, qualquer valor diferente de void vamos usar o return
int  soma2 (int n1, int n2){
...
//podemos fazer sobrecarga de funções declarando funções com nomes iguais mas seus argumentos são diferentes


//Atribuindo um valor para o argumento consigo omitir
void imp (string txt="");
...
//Valores inteiros
//Por padrão cada item tem um valor, ele sempre tem uma estrutura sequencial...primeiro item é 0
//Ele é sequencial apartir do numero anterior
...
//Coleção de variáveis e métodos
...
///############Continuando STRUCT CRIANDO UM ARRAY
...
// Não armazena o endereço de uma variavel, mas o endereço de outra variável, ele está apontando.
//Ponteiro tem que ser da mesma variável
...
//*********************************************************************************************************
///////////Aula 45 - POO, Classe em arquivo externo - Arquivo principal.cpp
...
//////Classes de Armazenamento externo*******************************
